...
public class GameSystem {
	...
	public BaseUnit promote(BaseUnit baseUnit, int choice) {
		...
		return switch (choice) {
			case 0 -> new MeleeUnit(baseUnit.getColumn(), baseUnit.getRow(), baseUnit.isWhite(), baseUnit.getName());
			case 1 -> new RangeUnit(baseUnit.getColumn(), baseUnit.getRow(), baseUnit.isWhite(), baseUnit.getName());
			case 2 -> new FlyingUnit(baseUnit.getColumn(), baseUnit.getRow(), baseUnit.isWhite(), baseUnit.getName());
			default -> null;
		};
	}
}
