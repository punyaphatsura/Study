...
public class TestDeck {
	...
	void testRemoveCard()  {
		...
		Card[] cardListnew2 = {NormalUnit1,NormalUnit1,NormalUnit1,NormalUnit2,NormalUnit2,NormalUnit2,NormalUnit2,};
		for (int i=0;i< deck2.getDeckSize();i++){
			assertEquals(deck2.getDeckList()[i],cardListnew2[i]);
		}

		Card[] cardListnew3 = {NormalUnit1,NormalUnit1,BuffSpellCard1,BuffSpellCard1,BuffSpellCard2,BuffSpellCard2};
		for (int i=0;i< deck3.getDeckSize();i++){
			assertEquals(deck3.getDeckList()[i],cardListnew3[i]);
		}
		...
		assertEquals(5,deck3.getDeckSize());
		cardListnew3 = new Card[]{NormalUnit1, BuffSpellCard1, BuffSpellCard1, BuffSpellCard2, BuffSpellCard2};
		for (int i=0;i< deck3.getDeckSize();i++){
			assertEquals(deck3.getDeckList()[i],cardListnew3[i]);
		}
	}
