...
public class TestVenomUnitCard {
	...
	@Test
	void testAttack(){
		assertEquals(100,oppoUnit1.getHealth());
		assertEquals(100,venomUnit1.attackUnit(oppoUnit1));
		assertEquals(0,oppoUnit1.getHealth());

		oppoUnit1.setHealth(200);
		assertEquals(200,oppoUnit1.getHealth());
		assertEquals(200,venomUnit2.attackUnit(oppoUnit1));
		assertEquals(0,oppoUnit1.getHealth());

		oppoUnit1.setHealth(9001);
		assertEquals(9001,oppoUnit1.getHealth());
		assertEquals(9001,venomUnit3.attackUnit(oppoUnit1));
		assertEquals(0,oppoUnit1.getHealth());
