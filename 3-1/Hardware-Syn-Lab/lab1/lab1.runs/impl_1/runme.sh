...
HD_PWD='C:/Users/Meep/Desktop/File/hw_syn_lab/lab1/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testerShiftAB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testerShiftAB.tcl -notrace
