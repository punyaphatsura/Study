...
HD_PWD='C:/Users/Meep/Desktop/File/hw_syn_lab/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testerShiftAB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testerShiftAB.tcl
