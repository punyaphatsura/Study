...
HD_PWD='C:/Users/Meep/Desktop/File/hw_syn_lab/project_lab2/project_lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combined.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source combined.tcl -notrace
