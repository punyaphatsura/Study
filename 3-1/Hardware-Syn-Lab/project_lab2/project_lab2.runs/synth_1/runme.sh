...
HD_PWD='C:/Users/Meep/Desktop/File/hw_syn_lab/project_lab2/project_lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combined.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combined.tcl
